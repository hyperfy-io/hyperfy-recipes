/**
 * This is a lightweight Tween lib that works well with time based
 * synchronization in Hyperfy.
 *
 * It's similar to Tween.js, but much simpler.
 *
 * It allows you to use Hyperfy's distributed server time to ensure all
 * clients see animation in the same state, even if they join in the middle
 * of a transition.
 */
...
// A quick test suite for showing/debugging how Tween works
// ---------------------------------------------------------------------------
